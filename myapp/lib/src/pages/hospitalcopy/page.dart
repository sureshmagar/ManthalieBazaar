...
class PageHospitalCopy extends StatefulWidget {
  const PageHospitalCopy({
    Key? key,
  }) : super(key: key);

  @override
  _StateHospitalCopy createState() => _StateHospitalCopy();
}

class _StateHospitalCopy extends State<PageHospitalCopy> {
